    ...
    <div class="card-body">
      ...
      <div class="card-meta">
        <div class="card-meta-row">
          ...
          <span class="meta-value code">${p.code}</span>
        </div>
        <div class="card-meta-row">
          <span class="meta-label">Хэмжээ</span>
          <span class="meta-value">${p.size}</span>
        </div>
        <div class="card-meta-row">
          <span class="meta-label">Гарал үүсэл</span>
          <span class="meta-value">${p.origin}</span>
        </div>
      </div>
    </div>
    <div class="card-footer">
      <button class="card-btn" data-id="${p.id}">
        Дэлгэрэнгүй ${ICONS.arrow}
      </button>
    </div>
  `;
